...
namespace NeuralNetwork.NeuralMath.Stats
{
    public static class ZScore
    {
        ...
        /// </summary>
        public static double RandomGaussianDistribution(double mean, double stdev)
        {
        ...
        {
            if (_PtoZ.TryGetValue(p, out double value))
            {
                return value;
            }
